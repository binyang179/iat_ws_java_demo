...
public class WebIATWS extends WebSocketListener {
    ...
    private static final String apiKey = "885598f37bed09ded72504a54934527f"; //在控制台-我的应用-语音听写（流式版）获取
    private static final String apiSecret = "395405f34078803e8ac62da4eada618d"; //在控制台-我的应用-语音听写（流式版）获取
    private static final String appid = "5d687b6b"; //在控制台-我的应用获取
    private static final String file = "/home/crab179/IdeaProjects/aiui/iat_ws_java_demo/resource/iat/16k_10.pcm"; // 中文
